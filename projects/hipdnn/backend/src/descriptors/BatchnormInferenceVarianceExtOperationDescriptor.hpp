...
class BatchnormInferenceVarianceExtOperationDescriptor
    : public HipdnnBackendDescriptorImpl<BatchnormInferenceVarianceExtOperationDescriptor>,
...
public:
    ...
    std::shared_ptr<TensorDescriptor> getVarianceDesc() const
    {
        return _varianceDesc;
    }
...
private:
    ...
    std::shared_ptr<TensorDescriptor> _varianceDesc;
