...
class SdpaBpropOperationDescriptor
    : public HipdnnBackendDescriptorImpl<SdpaBpropOperationDescriptor>,
...
public:
    ...
    // Creates a finalized SdpaBpropOperationDescriptor directly from a FlatBuffer NodeT.
    ...
    static std::shared_ptr<SdpaBpropOperationDescriptor>
