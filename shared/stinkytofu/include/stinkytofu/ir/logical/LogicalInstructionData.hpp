...
namespace stinkytofu
{
    ...
    struct MFMAData
    {
        ...
        MFMAData(const std::string& instType_,
                 const std::string& accType_,
                 int                m_,
                 int                n_,
                 int                k_,
                 int                blocks_,
    ...
    struct MXMFMAData
    {
        ...
        MXMFMAData(const std::string& instType_,
                   const std::string& accType_,
                   const std::string& mxScaleATypeStr_,
                   const std::string& mxScaleBTypeStr_,
                   int                m_,
                   int                n_,
                   int                k_,
                   int                block_,
    ...
    struct SMFMAData
    {
        ...
        SMFMAData(const std::string& instType_,
                  const std::string& accType_,
                  int                m_,
                  int                n_,
                  int                k_,
    ...
    struct LogicalLabelData
    {
        ...
        explicit LogicalLabelData(const std::string& name)
            : labelName(name)
        {
        }
    };
    ...
    struct IntrinsicCallData
    {
        ...
        explicit IntrinsicCallData(const std::string& name)
            : functionName(name)
        {
        }
    };
