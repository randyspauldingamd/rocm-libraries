...
struct BatchnormTestCase {
    ...
    BatchnormTestCase(std::vector<int64_t>&& dimsLocal, unsigned int seedLocal)
        : dims(std::move(dimsLocal)), seed(seedLocal) {
...
inline std::vector<BatchnormTestCase> getBnFwdInferenceTestCases() {
    ...
    return {
        {{1, 3, 14, 14}, seed},  {{1, 256, 1, 1}, seed}, {{2, 3, 1, 1}, seed},
        {{32, 1, 14, 14}, seed}, {{32, 3, 1, 14}, seed}, {{32, 3, 14, 1}, seed},
    };
}
...
inline std::vector<BatchnormTestCase> getBnBwdTestCases() {
    ...
    return {
        {{1, 3, 14, 14}, seed}, {{2, 3, 1, 1}, seed},   {{32, 1, 14, 14}, seed},
        {{32, 3, 1, 14}, seed}, {{32, 3, 14, 1}, seed},
    };
}
